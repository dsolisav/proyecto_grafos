...
test_dictionary_exec = {'Rojo':verticeR,'Verde':verticeV,'Azul':verticeA,'Blanco':verticeB}
#Creacion de aristas

lista_aristas_FA = cr.buildAristasFA(adyacenciaFA,verticeR, verticeB, verticeV, verticeA, test_dictionary_exec)
lista_aristas_DI = cr.buildAristasDI(adyacenciaDI,verticeR, verticeB, verticeV, verticeA, test_dictionary_exec)
lista_aristas_AA = cr.buildAristasAA(adyacenciaAA,verticeR, verticeB, verticeV, verticeA, test_dictionary_exec)

#----------------Comprobar aristas y diccionarios de adyacencia-----------------
print("Aristas del grafo general en orden FA, DI, AA: ")
print("\n")
